...
import Dep from './dep';
import type { VueConfig } from './component';

/** DIY Vue implementation with Proxy-based reactivity. */
export default class Vue {
  ...
  private _appendDom(): void {
    const { render } = this._config;
    const createElement = new Compile(this._vm);
    this._template = render(createElement) as Node;
  }
